...
class NHP_Options{
	...
	*/
	function __construct($sections = array(), $args = array(), $extra_tabs = array()){
		...
		$defaults['footer_credit'] = __('<span id="footer-thankyou">
    Options Panel created using the <a href="'.$this->framework_url.'" target="_blank">NHP Theme Options Framework Version 1.0.6</a> | Created by Lee Mason - <a href="http://twitter.com/lee__mason">Twiter</a>, <a href="http://uk.linkedin.com/pub/lee-mason/38/618/bab">LinkedIn</a></span>', 'nhp-opts');
